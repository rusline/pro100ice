$(document).ready(function() {
	...
	var yPosition=($('#slidebox'));
	$('#slidebox .next').css('top',yPosition);
	$('#slidebox .previous').css('top',yPosition);
	$('#slidebox .thumbs div:first-child').removeClass('thumb').addClass('selected_thumb');
	...
	if( !$("#slidebox .container").is(":animated")){
		if(slideTo=='next'){ //next
			...
			if(leftPosition==-slideboxTotalContent){
				...
				$('#slidebox .thumbs div:first-child').removeClass('thumb').addClass('selected_thumb');
				$('#slidebox .thumbs div:last-child').removeClass('selected_thumb').addClass('thumb');
			} else {
			...
			if(leftPosition=='0'){
				...
				$('#slidebox .thumbs div:last-child').removeClass('thumb').addClass('selected_thumb');
				$('#slidebox .thumbs div:first-child').removeClass('selected_thumb').addClass('thumb');
			} else {
			...
			if(leftPosition!=-slide2){
				...
				var selThumb=$('#slidebox .thumbs div').eq((slideTo-1));
